...
class FluentConditionBuilder(ConditionBuilder):
    ...
    def at_most_n_of(self, n: int, *strings: str) -> Self:
    ...
    def between_n_and_m_of(self, min_n: int, max_m: int, *strings: str) -> Self:
    ...
    def string_matches(self, string_id: str) -> Self:
