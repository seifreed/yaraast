...
from yaraast.metrics import ComplexityAnalyzer, DependencyGraphGenerator, StringDiagramGenerator
...
class ParallelAnalyzer:
    ...
    def start(self) -> None:
        ...
        if self._executor is None:
            self._executor = ThreadPoolExecutor(
                ...
                thread_name_prefix="yaraast-worker"
            )
    ...
    def parse_files_parallel(self,
                            ...
                            chunk_size: int = 10) -> List[AnalysisJob[YaraFile]]:
    ...
    def analyze_complexity_parallel(self,
                                   asts: List[YaraFile],
                                   file_names: Optional[List[str]] = None) -> List[AnalysisJob]:
    ...
    def generate_graphs_parallel(self,
                                asts: List[YaraFile],
                                output_dir: Optional[Path] = None,
                                graph_types: List[str] = None) -> List[AnalysisJob]:
    ...
    def process_batch(self,
                     ...
                     max_concurrent: Optional[int] = None) -> List[AnalysisJob]:
    ...
    def _submit_job(self,
                   ...
                   parameters: Optional[Dict[str, Any]] = None) -> AnalysisJob:
    ...
    def _parse_files_worker(self, file_paths: List[Path], parameters: Dict[str, Any]) -> List[YaraFile]:
...
class ProgressTracker:
    ...
    def update(self, increment: int = 1) -> Optional[Dict[str, Any]]:
