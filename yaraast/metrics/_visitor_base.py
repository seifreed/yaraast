...
class MetricsVisitorBase(DefaultASTVisitor[Any]):
    ...
    def visit_dict_comprehension(self, node: Any) -> Any:
    ...
    def visit_list_expression(self, node: Any) -> Any:
        self._visit_ast_value(node.elements)
        return self._default

    def visit_dict_expression(self, node: Any) -> Any:
        self._visit_ast_value(node.items)
        return self._default

    def visit_dict_item(self, node: Any) -> Any:
    ...
    def visit_lambda_expression(self, node: Any) -> Any:
        self._visit_ast_value(node.body)
        return self._default
