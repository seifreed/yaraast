...
KEYWORD_DOCS: dict[str, str] = {
    ...
    "none": "Quantifier meaning 'none of'",
    ...
    "as": "Introduces a loop variable in for expressions",
    ...
    "matches": "Regular expression match operator for string expressions",
    "contains": "Substring containment operator for string expressions",
    "startswith": "Tests whether a string expression starts with another string",
    "endswith": "Tests whether a string expression ends with another string",
    "icontains": "Case-insensitive substring containment operator",
    "istartswith": "Case-insensitive string prefix operator",
    "iendswith": "Case-insensitive string suffix operator",
    "iequals": "Case-insensitive string equality operator",
